namespace WowPacketParserModule.V8_0_1_27101.Enums
{
    ...
    {
        ACTIVEPLAYER_DYNAMIC_FIELD_HEIRLOOMS                    = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x000, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_HEIRLOOM_FLAGS               = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x001, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_TOYS                         = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x002, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_TRANSMOG                     = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x003, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_CONDITIONAL_TRANSMOG         = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x004, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_SELF_RES_SPELLS              = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x005, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_CHARACTER_RESTRICTIONS       = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x006, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_SPELL_PCT_MOD_BY_LABEL       = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x007, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_SPELL_FLAT_MOD_BY_LABEL      = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x008, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_FIELD_RESEARCH                     = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x009, // Flags: PUBLIC
        ACTIVEPLAYER_DYNAMIC_END                                = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x00A,
    };
