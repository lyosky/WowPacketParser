...
namespace WowPacketParserModule.V7_0_3_22248.Parsers
{
    public static class BattlePayHandler
    {
        ...
        private static void ReadBattlePayProduct70x(Packet packet, params object[] idx)
        {
            ...
            var int11 = packet.ReadInt32("BattlepayProductItemCount", idx);//packet.ReadBits("BattlepayProductItemCount", 7, idx);
            

            packet.ReadInt32("Flags", idx);

            packet.ReadInt32("ChoiceType", idx);//ChoiceType?

            packet.ReadInt32("ProductID", idx);
            //packet.ReadByte("Type", idx);
            packet.ReadBits("Type 1", 7, idx);
        ...
        private static void ReadBattlePayDistributionObject(Packet packet, params object[] index)
        {
            ...
            if (bit5248)
            {
                if (ClientVersion.AddedInVersion(ClientVersionBuild.V7_0_3_22248))
                    ReadBattlePayProduct70x(packet, index);
                else
        ...
        public static void HandletBattlePayGetProductListResponse(Packet packet)
        {
            ...
            packet.ReadUInt32("ProductItemDisplayCardsCount");
